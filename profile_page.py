...
def profile_content(content_frame):
    ...
    def hide_profile_values(event):
        ...
        # Create CTkEntry widgets for editing with transparent background and no border
        ...
        widgets.append(save_button_profile)
    ...
    def hide_userpass_values(event):
        ...
        widgets.append(save_button_userpass)
